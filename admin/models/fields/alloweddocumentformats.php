...
/**
 * Alloweddocumentformats Form Field class for the Questionsanswers component
 */
class JFormFieldAlloweddocumentformats extends JFormFieldList
{
	/**
	...
	protected function getOptions()
	{
		...
		$extensionList = QuestionsanswersHelper::getFileExtensions('document', true);

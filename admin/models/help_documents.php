...
class QuestionsanswersModelHelp_documents extends JModelList
{
	...
	public function selectionTranslation($value,$name)
	{
		...
		{
			$typeArray = array(
				0 => 'COM_QUESTIONSANSWERS_HELP_DOCUMENT_SELECT_AN_OPTION',
				1 => 'COM_QUESTIONSANSWERS_HELP_DOCUMENT_JOOMLA_ARTICLE',
				2 => 'COM_QUESTIONSANSWERS_HELP_DOCUMENT_TEXT',
				3 => 'COM_QUESTIONSANSWERS_HELP_DOCUMENT_URL'
			);
			// Now check if value is found in this array
			if (isset($typeArray[$value]) && QuestionsanswersHelper::checkString($typeArray[$value]))
			{
		...
		{
			$locationArray = array(
				1 => 'COM_QUESTIONSANSWERS_HELP_DOCUMENT_ADMIN',
				2 => 'COM_QUESTIONSANSWERS_HELP_DOCUMENT_SITE'
			);
			// Now check if value is found in this array
			if (isset($locationArray[$value]) && QuestionsanswersHelper::checkString($locationArray[$value]))
			{
	...
	*/
	public function getExImPortHeaders()
	{
		...
		$db = JFactory::getDbo();
		// get the columns
		$columns = $db->getTableColumns("#__questionsanswers_help_document");

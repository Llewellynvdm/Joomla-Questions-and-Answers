...
class QuestionsanswersTableHelp_document extends JTable
{
	...
	{
		parent::__construct('#__questionsanswers_help_document', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_questionsanswers.help_document'));
	}	
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_QUESTIONSANSWERS_HELP_DOCUMENT_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_questionsanswers.help_document.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_questionsanswers.help_document.'.(int) $this->$k;
	}

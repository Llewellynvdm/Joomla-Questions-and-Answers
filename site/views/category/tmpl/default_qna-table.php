...
<?php if ($this->user->authorise('question_and_answer.create', 'com_questionsanswers')): ?>
	<a class="uk-button uk-button-success" href="<?php echo JURI::root(); ?>index.php?option=com_questionsanswers&view=category&task=question_and_answer.edit&ref=category">
...
<script type="text/javascript">
	...
	// the get url
	var columnsUrl = "<?php echo JURI::root(); ?>index.php?option=com_questionsanswers&task=ajax.getColumns&format=json&raw=true&page=category&token="+token+"&vdm="+vastDevMod;
	var rowsUrl = "<?php echo JURI::root(); ?>index.php?option=com_questionsanswers&task=ajax.getRows&format=json&raw=true&page=category&token="+token+"&key="+key+"&vdm="+vastDevMod;
	jQuery(function($){
		<?php if (isset($this->buttons) && $this->buttons): ?>

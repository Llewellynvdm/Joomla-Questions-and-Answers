...
/**
 * Questionsanswers Html View class for the Downloads
 */
class QuestionsanswersViewDownloads extends HtmlView
{
	...
	*/
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_questionsanswers/assets/css/downloads.css', (QuestionsanswersHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		$this->help_url = QuestionsanswersHelper::getHelpUrl('downloads');
